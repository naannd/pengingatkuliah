...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h2>Tambah Tugas</h2>
            <p>Tambahkan tugas baru dan atur deadlinenya</p>
        </div>
...
<div class="dashboard-card" style="max-width:660px">
    ...
    <form action="{{ route('tugas.store') }}" method="POST" class="form-styled">
        @csrf
        ...
        <div class="mb-3">
            ...
            <input type="text" name="judul"
                   ...
                   value="{{ old('judul') }}"
                   placeholder="Contoh: Laporan Praktikum Basis Data" autofocus>
        ...
        <div class="mb-3">
            ...
            <textarea name="deskripsi" rows="3"
                      ...
                      placeholder="Deskripsi singkat tugas...">{{ old('deskripsi') }}</textarea>
        ...
        <div class="mb-3">
            <label>Progress: <span id="progressVal" style="color:var(--orange);font-weight:700">{{ old('progress', 0) }}%</span></label>
